...
class UserSerializer(serializers.ModelSerializer):
  class Meta:    # Meta class tells django rest framework what fields we want to take from our model. 
    ...
    extra_kwargs = {'password': {'write_only': True}}   #Here, kwargs refer to "keyword arguments" and we created a dictionary with curly brackets and we added the key "password" which corresponds to which specific field we want to add special keyword arguments to.
